...
namespace Domain.Migrations
{
    ...
    [Migration("20260108140722_AddCarts")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Idenity.RoleEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.Idenity.UserEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.Idenity.UserRoleEntity", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.CartEntity", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Idenity.UserEntity", "User")
                        .WithMany("Carts")
            ...
            modelBuilder.Entity("Domain.Entities.Idenity.UserRoleEntity", b =>
                {
                    b.HasOne("Domain.Entities.Idenity.RoleEntity", "Role")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Domain.Entities.Idenity.UserEntity", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
